 ...
 * 
 */
@WebFault(name = "OpCrearFallo", targetNamespace = "http://www.ugpp.gov.co/Liquidador/SrvAplNomina")
public class MsjOpCrearFallo
    extends Exception
{
     ...
     * @param faultInfo
     */
    public MsjOpCrearFallo(String message, FalloTipo faultInfo) {
        super(message);
     ...
     * @param cause
     */
    public MsjOpCrearFallo(String message, FalloTipo faultInfo, Throwable cause) {
        super(message, cause);
        this.faultInfo = faultInfo;
    }
